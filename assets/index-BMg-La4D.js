...
*/var mr,Aw;(function(){var t;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(v,y){function E(){}E.prototype=y.prototype,v.F=y.prototype,v.prototype=new E,v.prototype.constructor=v,v.D=function(A,C,x){for(var w=Array(arguments.length-2),De=2;De<arguments.length;De++)w[De-2]=arguments[De];return y.prototype[C].apply(A,w)}}function n(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,n),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(v,y,E){E||(E=0);const A=Array(16);if(typeof y=="string")for(var C=0;C<16;++C)A[C]=y.charCodeAt(E++)|y.charCodeAt(E++)<<8|y.charCodeAt(E++)<<16|y.charCodeAt(E++)<<24;else for(C=0;C<16;++C)A[C]=y[E++]|y[E++]<<8|y[E++]<<16|y[E++]<<24;y=v.g[0],E=v.g[1],C=v.g[2];let x=v.g[3],w;w=y+(x^E&(C^x))+A[0]+3614090360&4294967295,y=E+(w<<7&4294967295|w>>>25),w=x+(C^y&(E^C))+A[1]+3905402710&4294967295,x=y+(w<<12&4294967295|w>>>20),w=C+(E^x&(y^E))+A[2]+606105819&4294967295,C=x+(w<<17&4294967295|w>>>15),w=E+(y^C&(x^y))+A[3]+3250441966&4294967295,E=C+(w<<22&4294967295|w>>>10),w=y+(x^E&(C^x))+A[4]+4118548399&4294967295,y=E+(w<<7&4294967295|w>>>25),w=x+(C^y&(E^C))+A[5]+1200080426&4294967295,x=y+(w<<12&4294967295|w>>>20),w=C+(E^x&(y^E))+A[6]+2821735955&4294967295,C=x+(w<<17&4294967295|w>>>15),w=E+(y^C&(x^y))+A[7]+4249261313&4294967295,E=C+(w<<22&4294967295|w>>>10),w=y+(x^E&(C^x))+A[8]+1770035416&4294967295,y=E+(w<<7&4294967295|w>>>25),w=x+(C^y&(E^C))+A[9]+2336552879&4294967295,x=y+(w<<12&4294967295|w>>>20),w=C+(E^x&(y^E))+A[10]+4294925233&4294967295,C=x+(w<<17&4294967295|w>>>15),w=E+(y^C&(x^y))+A[11]+2304563134&4294967295,E=C+(w<<22&4294967295|w>>>10),w=y+(x^E&(C^x))+A[12]+1804603682&4294967295,y=E+(w<<7&4294967295|w>>>25),w=x+(C^y&(E^C))+A[13]+4254626195&4294967295,x=y+(w<<12&4294967295|w>>>20),w=C+(E^x&(y^E))+A[14]+2792965006&4294967295,C=x+(w<<17&4294967295|w>>>15),w=E+(y^C&(x^y))+A[15]+1236535329&4294967295,E=C+(w<<22&4294967295|w>>>10),w=y+(C^x&(E^C))+A[1]+4129170786&4294967295,y=E+(w<<5&4294967295|w>>>27),w=x+(E^C&(y^E))+A[6]+3225465664&4294967295,x=y+(w<<9&4294967295|w>>>23),w=C+(y^E&(x^y))+A[11]+643717713&4294967295,C=x+(w<<14&4294967295|w>>>18),w=E+(x^y&(C^x))+A[0]+3921069994&4294967295,E=C+(w<<20&4294967295|w>>>12),w=y+(C^x&(E^C))+A[5]+3593408605&4294967295,y=E+(w<<5&4294967295|w>>>27),w=x+(E^C&(y^E))+A[10]+38016083&4294967295,x=y+(w<<9&4294967295|w>>>23),w=C+(y^E&(x^y))+A[15]+3634488961&4294967295,C=x+(w<<14&4294967295|w>>>18),w=E+(x^y&(C^x))+A[4]+3889429448&4294967295,E=C+(w<<20&4294967295|w>>>12),w=y+(C^x&(E^C))+A[9]+568446438&4294967295,y=E+(w<<5&4294967295|w>>>27),w=x+(E^C&(y^E))+A[14]+3275163606&4294967295,x=y+(w<<9&4294967295|w>>>23),w=C+(y^E&(x^y))+A[3]+4107603335&4294967295,C=x+(w<<14&4294967295|w>>>18),w=E+(x^y&(C^x))+A[8]+1163531501&4294967295,E=C+(w<<20&4294967295|w>>>12),w=y+(C^x&(E^C))+A[13]+2850285829&4294967295,y=E+(w<<5&4294967295|w>>>27),w=x+(E^C&(y^E))+A[2]+4243563512&4294967295,x=y+(w<<9&4294967295|w>>>23),w=C+(y^E&(x^y))+A[7]+1735328473&4294967295,C=x+(w<<14&4294967295|w>>>18),w=E+(x^y&(C^x))+A[12]+2368359562&4294967295,E=C+(w<<20&4294967295|w>>>12),w=y+(E^C^x)+A[5]+4294588738&4294967295,y=E+(w<<4&4294967295|w>>>28),w=x+(y^E^C)+A[8]+2272392833&4294967295,x=y+(w<<11&4294967295|w>>>21),w=C+(x^y^E)+A[11]+1839030562&4294967295,C=x+(w<<16&4294967295|w>>>16),w=E+(C^x^y)+A[14]+4259657740&4294967295,E=C+(w<<23&4294967295|w>>>9),w=y+(E^C^x)+A[1]+2763975236&4294967295,y=E+(w<<4&4294967295|w>>>28),w=x+(y^E^C)+A[4]+1272893353&4294967295,x=y+(w<<11&4294967295|w>>>21),w=C+(x^y^E)+A[7]+4139469664&4294967295,C=x+(w<<16&4294967295|w>>>16),w=E+(C^x^y)+A[10]+3200236656&4294967295,E=C+(w<<23&4294967295|w>>>9),w=y+(E^C^x)+A[13]+681279174&4294967295,y=E+(w<<4&4294967295|w>>>28),w=x+(y^E^C)+A[0]+3936430074&4294967295,x=y+(w<<11&4294967295|w>>>21),w=C+(x^y^E)+A[3]+3572445317&4294967295,C=x+(w<<16&4294967295|w>>>16),w=E+(C^x^y)+A[6]+76029189&4294967295,E=C+(w<<23&4294967295|w>>>9),w=y+(E^C^x)+A[9]+3654602809&4294967295,y=E+(w<<4&4294967295|w>>>28),w=x+(y^E^C)+A[12]+3873151461&4294967295,x=y+(w<<11&4294967295|w>>>21),w=C+(x^y^E)+A[15]+530742520&4294967295,C=x+(w<<16&4294967295|w>>>16),w=E+(C^x^y)+A[2]+3299628645&4294967295,E=C+(w<<23&4294967295|w>>>9),w=y+(C^(E|~x))+A[0]+4096336452&4294967295,y=E+(w<<6&4294967295|w>>>26),w=x+(E^(y|~C))+A[7]+1126891415&4294967295,x=y+(w<<10&4294967295|w>>>22),w=C+(y^(x|~E))+A[14]+2878612391&4294967295,C=x+(w<<15&4294967295|w>>>17),w=E+(x^(C|~y))+A[5]+4237533241&4294967295,E=C+(w<<21&4294967295|w>>>11),w=y+(C^(E|~x))+A[12]+1700485571&4294967295,y=E+(w<<6&4294967295|w>>>26),w=x+(E^(y|~C))+A[3]+2399980690&4294967295,x=y+(w<<10&4294967295|w>>>22),w=C+(y^(x|~E))+A[10]+4293915773&4294967295,C=x+(w<<15&4294967295|w>>>17),w=E+(x^(C|~y))+A[1]+2240044497&4294967295,E=C+(w<<21&4294967295|w>>>11),w=y+(C^(E|~x))+A[8]+1873313359&4294967295,y=E+(w<<6&4294967295|w>>>26),w=x+(E^(y|~C))+A[15]+4264355552&4294967295,x=y+(w<<10&4294967295|w>>>22),w=C+(y^(x|~E))+A[6]+2734768916&4294967295,C=x+(w<<15&4294967295|w>>>17),w=E+(x^(C|~y))+A[13]+1309151649&4294967295,E=C+(w<<21&4294967295|w>>>11),w=y+(C^(E|~x))+A[4]+4149444226&4294967295,y=E+(w<<6&4294967295|w>>>26),w=x+(E^(y|~C))+A[11]+3174756917&4294967295,x=y+(w<<10&4294967295|w>>>22),w=C+(y^(x|~E))+A[2]+718787259&4294967295,C=x+(w<<15&4294967295|w>>>17),w=E+(x^(C|~y))+A[9]+3951481745&4294967295,v.g[0]=v.g[0]+y&4294967295,v.g[1]=v.g[1]+(C+(w<<21&4294967295|w>>>11))&4294967295,v.g[2]=v.g[2]+C&4294967295,v.g[3]=v.g[3]+x&4294967295}r.prototype.v=function(v,y){y===void 0&&(y=v.length);const E=y-this.blockSize,A=this.C;let C=this.h,x=0;for(;x<y;){if(C==0)for(;x<=E;)i(this,v,x),x+=this.blockSize;if(typeof v=="string"){for(;x<y;)if(A[C++]=v.charCodeAt(x++),C==this.blockSize){i(this,A),C=0;break}}else for(;x<y;)if(A[C++]=v[x++],C==this.blockSize){i(this,A),C=0;break}}this.h=C,this.o+=y},r.prototype.A=function(){var v=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);v[0]=128;for(var y=1;y<v.length-8;++y)v[y]=0;y=this.o*8;for(var E=v.length-8;E<v.length;++E)v[E]=y&255,y/=256;for(this.v(v),v=Array(16),y=0,E=0;E<4;++E)for(let A=0;A<32;A+=8)v[y++]=this.g[E]>>>A&255;return v};function s(v,y){var E=l;return Object.prototype.hasOwnProperty.call(E,v)?E[v]:E[v]=y(v)}function o(v,y){this.h=y;const E=[];let A=!0;for(let C=v.length-1;C>=0;C--){const x=v[C]|0;A&&x==y||(E[C]=x,A=!1)}this.g=E}var l={};function u(v){return-128<=v&&v<128?s(v,function(y){return new o([y|0],y<0?-1:0)}):new o([v|0],v<0?-1:0)}function c(v){if(isNaN(v)||!isFinite(v))return p;if(v<0)return N(c(-v));const y=[];let E=1;for(let A=0;v>=E;A++)y[A]=v/E|0,E*=4294967296;return new o(y,0)}function f(v,y){if(v.length==0)throw Error("number format error: empty string");if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(v.charAt(0)=="-")return N(f(v.substring(1),y));if(v.indexOf("-")>=0)throw Error('number format error: interior "-" character');const E=c(Math.pow(y,8));let A=p;for(let x=0;x<v.length;x+=8){var C=Math.min(8,v.length-x);const w=parseInt(v.substring(x,x+C),y);C<8?(C=c(Math.pow(y,C)),A=A.j(C).add(c(w))):(A=A.j(E),A=A.add(c(w)))}return A}var p=u(0),m=u(1),S=u(16777216);t=o.prototype,t.m=function(){if(k(this))return-N(this).m();let v=0,y=1;for(let E=0;E<this.g.length;E++){const A=this.i(E);v+=(A>=0?A:4294967296+A)*y,y*=4294967296}return v},t.toString=function(v){if(v=v||10,v<2||36<v)throw Error("radix out of range: "+v);if(P(this))return"0";if(k(this))return"-"+N(this).toString(v);const y=c(Math.pow(v,6));var E=this;let A="";for(;;){const C=O(E,y).g;E=T(E,C.j(y));let x=((E.g.length>0?E.g[0]:E.h)>>>0).toString(v);if(E=C,P(E))return x+A;for(;x.length<6;)x="0"+x;A=x+A}},t.i=function(v){return v<0?0:v<this.g.length?this.g[v]:this.h};function P(v){if(v.h!=0)return!1;for(let y=0;y<v.g.length;y++)if(v.g[y]!=0)return!1;return!0}function k(v){return v.h==-1}t.l=function(v){return v=T(this,v),k(v)?-1:P(v)?0:1};function N(v){const y=v.g.length,E=[];for(let A=0;A<y;A++)E[A]=~v.g[A];return new o(E,~v.h).add(m)}t.abs=function(){return k(this)?N(this):this},t.add=function(v){const y=Math.max(this.g.length,v.g.length),E=[];let A=0;for(let C=0;C<=y;C++){let x=A+(this.i(C)&65535)+(v.i(C)&65535),w=(x>>>16)+(this.i(C)>>>16)+(v.i(C)>>>16);A=w>>>16,x&=65535,w&=65535,E[C]=w<<16|x}return new o(E,E[E.length-1]&-2147483648?-1:0)};function T(v,y){return v.add(N(y))}t.j=function(v){if(P(this)||P(v))return p;if(k(this))return k(v)?N(this).j(N(v)):N(N(this).j(v));if(k(v))return N(this.j(N(v)));if(this.l(S)<0&&v.l(S)<0)return c(this.m()*v.m());const y=this.g.length+v.g.length,E=[];for(var A=0;A<2*y;A++)E[A]=0;for(A=0;A<this.g.length;A++)for(let C=0;C<v.g.length;C++){const x=this.i(A)>>>16,w=this.i(A)&65535,De=v.i(C)>>>16,dn=v.i(C)&65535;E[2*A+2*C]+=w*dn,_(E,2*A+2*C),E[2*A+2*C+1]+=x*dn,_(E,2*A+2*C+1),E[2*A+2*C+1]+=w*De,_(E,2*A+2*C+1),E[2*A+2*C+2]+=x*De,_(E,2*A+2*C+2)}for(v=0;v<y;v++)E[v]=E[2*v+1]<<16|E[2*v];for(v=y;v<2*y;v++)E[v]=0;return new o(E,0)};function _(v,y){for(;(v[y]&65535)!=v[y];)v[y+1]+=v[y]>>>16,v[y]&=65535,y++}function R(v,y){this.g=v,this.h=y}function O(v,y){if(P(y))throw Error("division by zero");if(P(v))return new R(p,p);if(k(v))return y=O(N(v),y),new R(N(y.g),N(y.h));if(k(y))return y=O(v,N(y)),new R(N(y.g),y.h);if(v.g.length>30){if(k(v)||k(y))throw Error("slowDivide_ only works with positive integers.");for(var E=m,A=y;A.l(v)<=0;)E=b(E),A=b(A);var C=j(E,1),x=j(A,1);for(A=j(A,2),E=j(E,2);!P(A);){var w=x.add(A);w.l(v)<=0&&(C=C.add(E),x=w),A=j(A,1),E=j(E,1)}return y=T(v,C.j(y)),new R(C,y)}for(C=p;v.l(y)>=0;){for(E=Math.max(1,Math.floor(v.m()/y.m())),A=Math.ceil(Math.log(E)/Math.LN2),A=A<=48?1:Math.pow(2,A-48),x=c(E),w=x.j(y);k(w)||w.l(v)>0;)E-=A,x=c(E),w=x.j(y);P(x)&&(x=m),C=C.add(x),v=T(v,w)}return new R(C,v)}t.B=function(v){return O(this,v).h},t.and=function(v){const y=Math.max(this.g.length,v.g.length),E=[];for(let A=0;A<y;A++)E[A]=this.i(A)&v.i(A);return new o(E,this.h&v.h)},t.or=function(v){const y=Math.max(this.g.length,v.g.length),E=[];for(let A=0;A<y;A++)E[A]=this.i(A)|v.i(A);return new o(E,this.h|v.h)},t.xor=function(v){const y=Math.max(this.g.length,v.g.length),E=[];for(let A=0;A<y;A++)E[A]=this.i(A)^v.i(A);return new o(E,this.h^v.h)};function b(v){const y=v.g.length+1,E=[];for(let A=0;A<y;A++)E[A]=v.i(A)<<1|v.i(A-1)>>>31;return new o(E,v.h)}function j(v,y){const E=y>>5;y%=32;const A=v.g.length-E,C=[];for(let x=0;x<A;x++)C[x]=y>0?v.i(x+E)>>>y|v.i(x+E+1)<<32-y:v.i(x+E);return new o(C,v.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,Aw=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=c,o.fromString=f,mr=o}).apply(typeof cy<"u"?cy:typeof self<"u"?self:typeof window<"u"?window:{});var Ga=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */pr(FD,UD,"app");const jD={apiKey:"AIzaSyD8Njd86Md8JF9wp4KNrLWdjgKBJeNwCW4",authDomain:"steptracker-f5940.firebaseapp.com",projectId:"steptracker-f5940",storageBucket:"steptracker-f5940.firebasestorage.app",messagingSenderId:"33755841143",appId:"1:33755841143:web:d7f69852d038bbc0e4fc72"},o0=BE(jD),Rr=dk(o0),Le=vD(o0);function BD(){ra();const[t,e]=F.useState({email:"",password:""}),[n,r]=F.useState(""),[i,s]=F.useState(!1);async function o(l){l.preventDefault(),r(""),s(!0);try{await Q1(Rr,t.email,t.password)}catch{r("Invalid email or password"),s(!1)}}return I.jsx("div",{className:"min-h-screen flex items-center justify-center px-4",style:{background:"#0f1117"},children:I.jsxs("div",{className:"w-full max-w-sm rounded-xl p-8",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("div",{className:"flex justify-center mb-4",children:I.jsx("img",{src:"/steptracker/pivotal logo.png",alt:"Pivotal Logo",className:"h-16 object-contain"})}),I.jsx("h1",{className:"text-2xl font-bold text-center text-white mb-1",children:"🏃 StepTracker"}),I.jsx("p",{className:"text-center text-slate-400 text-sm mb-6",children:"Company Step Challenge"}),n&&I.jsx("div",{className:"mb-4 p-3 rounded-lg text-sm",style:{background:"#7f1d1d",color:"#fca5a5"},children:n}),I.jsxs("form",{onSubmit:o,className:"space-y-4",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Email"}),I.jsx("input",{type:"email",required:!0,value:t.email,onChange:l=>e({...t,email:l.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"you@company.com"})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Password"}),I.jsx("input",{type:"password",required:!0,value:t.password,onChange:l=>e({...t,password:l.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"••••••••"})]}),I.jsx("button",{type:"submit",disabled:i,className:"w-full font-semibold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 text-white",style:{background:"#4f8ef7"},children:i?"Signing in...":"Sign In"})]}),I.jsxs("p",{className:"text-center text-sm text-slate-500 mt-4",children:["No account?"," ",I.jsx(Kn,{to:"/register",className:"text-blue-400 hover:underline font-medium",children:"Register here"})]})]})})}function zD(){ra();const[t,e]=F.useState({name:"",email:"",password:""}),[n,r]=F.useState(""),[i,s]=F.useState(!1);async function o(l){l.preventDefault(),r(""),s(!0);try{const{user:u}=await G1(Rr,t.email,t.password);await J1(u,{displayName:t.name}),await yp(Sn(Le,"users",u.uid),{name:t.name,email:t.email.toLowerCase(),role:"user",createdAt:xD()})}catch(u){u.code==="auth/email-already-in-use"?r("Email already registered"):u.code==="auth/weak-password"?r("Password must be at least 6 characters"):r("Registration failed. Please try again.")}finally{s(!1)}}return I.jsx("div",{className:"min-h-screen flex items-center justify-center px-4",style:{background:"#0f1117"},children:I.jsxs("div",{className:"w-full max-w-sm rounded-xl p-8",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("h1",{className:"text-2xl font-bold text-center text-white mb-1",children:"🏃 StepTracker"}),I.jsx("p",{className:"text-center text-slate-400 text-sm mb-6",children:"Create your account"}),n&&I.jsx("div",{className:"mb-4 p-3 rounded-lg text-sm",style:{background:"#7f1d1d",color:"#fca5a5"},children:n}),I.jsxs("form",{onSubmit:o,className:"space-y-4",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Full Name"}),I.jsx("input",{type:"text",required:!0,value:t.name,onChange:l=>e({...t,name:l.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"Jane Smith"})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Email"}),I.jsx("input",{type:"email",required:!0,value:t.email,onChange:l=>e({...t,email:l.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"you@company.com"})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Password"}),I.jsx("input",{type:"password",required:!0,value:t.password,onChange:l=>e({...t,password:l.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"Min. 6 characters"})]}),I.jsx("button",{type:"submit",disabled:i,className:"w-full font-semibold py-3 px-4 rounded-lg transition-colors disabled:opacity-50 text-white",style:{background:"#4f8ef7"},children:i?"Creating account...":"Create Account"})]}),I.jsxs("p",{className:"text-center text-sm text-slate-500 mt-4",children:["Already have an account?"," ",I.jsx(Kn,{to:"/login",className:"text-blue-400 hover:underline font-medium",children:"Sign in"})]})]})})}function Za({label:t,value:e}){return I.jsxs("div",{className:"rounded-lg p-3",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("p",{className:"text-xs text-slate-500 uppercase tracking-wide font-semibold",children:t}),I.jsx("p",{className:"text-xl font-bold text-white mt-1",children:typeof e=="number"?e.toLocaleString():e})]})}function $D(){const t=Rr.currentUser,[e,n]=F.useState([]),[r,i]=F.useState({today:0,week:0,month:0,rank:1}),[s,o]=F.useState({date:new Date().toISOString().split("T")[0],steps:""}),[l,u]=F.useState(""),[c,f]=F.useState("");async function p(){if(!t)return;const P=us(Zt(Le,"stepEntries"),Jo("userId","==",t.uid),r0("date","desc"),VD(90)),N=(await En(P)).docs.map(x=>({id:x.id,...x.data()}));n(N);const T=new Date().toISOString().split("T")[0],_=new Date(Date.now()-7*864e5).toISOString().split("T")[0],R=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0],O=N.find(x=>x.date===T),b=N.filter(x=>x.date>=_).reduce((x,w)=>x+w.steps,0),j=N.filter(x=>x.date>=R).reduce((x,w)=>x+w.steps,0),v=us(Zt(Le,"stepEntries"),Jo("date",">=",R)),y=await En(v),E={};y.docs.forEach(x=>{const{userId:w,steps:De}=x.data();E[w]=(E[w]||0)+De});const A=E[t.uid]||0,C=Object.values(E).filter(x=>x>A).length+1;i({today:(O==null?void 0:O.steps)??0,week:b,month:j,rank:C})}F.useEffect(()=>{p()},[]);async function m(P){P.preventDefault(),u(""),f("");try{const k=`${t.uid}_${s.date}`,N=e.find(_=>_.date===s.date),T=(N?N.steps:0)+parseInt(s.steps);await yp(Sn(Le,"stepEntries",k),{userId:t.uid,date:s.date,steps:T,updatedAt:new Date().toISOString()}),u(N?`✅ Steps added! Total for ${s.date}: ${T.toLocaleString()}`:"✅ Steps saved!"),o({...s,steps:""}),p()}catch{f("Failed to save steps. Try again.")}}async function S(P){confirm("Delete this entry?")&&(await fu(Sn(Le,"stepEntries",P)),p())}return I.jsxs("div",{className:"space-y-5",children:[I.jsx("h2",{className:"text-xl font-bold text-white",children:"My Dashboard"}),I.jsxs("div",{className:"grid grid-cols-2 gap-3 sm:grid-cols-4",children:[I.jsx(Za,{label:"Today",value:r.today}),I.jsx(Za,{label:"This Week",value:r.week}),I.jsx(Za,{label:"This Month",value:r.month}),I.jsx(Za,{label:"My Rank",value:`#${r.rank}`})]}),I.jsxs("div",{className:"rounded-xl p-5",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("h3",{className:"text-base font-semibold text-white mb-4",children:"Log My Steps"}),l&&I.jsx("div",{className:"mb-3 p-3 rounded-lg text-sm font-medium",style:{background:"#064e3b",color:"#6ee7b7"},children:l}),c&&I.jsx("div",{className:"mb-3 p-3 rounded-lg text-sm",style:{background:"#7f1d1d",color:"#fca5a5"},children:c}),I.jsxs("form",{onSubmit:m,className:"flex flex-col gap-4",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Date"}),I.jsx("input",{type:"date",value:s.date,max:new Date().toISOString().split("T")[0],onChange:P=>o({...s,date:P.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"}})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-sm font-medium text-slate-300 mb-2",children:"Steps"}),I.jsx("input",{type:"number",required:!0,min:"0",max:"100000",value:s.steps,onChange:P=>o({...s,steps:P.target.value}),className:"w-full rounded-lg px-4 py-3 text-base text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#13151f",border:"1px solid #2d3148"},placeholder:"e.g. 8500"})]}),I.jsx("button",{type:"submit",className:"w-full font-bold py-4 rounded-xl text-base text-white transition-colors",style:{background:"#4f8ef7"},children:"💾 Save Steps"})]})]}),I.jsxs("div",{className:"rounded-xl overflow-hidden",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("div",{className:"px-5 py-4",style:{borderBottom:e.length>0?"1px solid #2d3148":"none"},children:I.jsx("h3",{className:"font-semibold text-white",children:"Recent Entries"})}),e.length===0?I.jsx("p",{className:"px-5 py-8 text-center text-slate-500",children:"No steps logged yet. Start tracking!"}):I.jsxs("table",{className:"w-full text-sm",children:[I.jsx("thead",{style:{background:"#212435"},children:I.jsxs("tr",{children:[I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium",children:"Date"}),I.jsx("th",{className:"text-right px-5 py-3 text-slate-400 font-medium",children:"Steps"}),I.jsx("th",{className:"px-5 py-3"})]})}),I.jsx("tbody",{children:e.map(P=>I.jsxs("tr",{style:{borderBottom:"1px solid #2d3148"},className:"hover:bg-white/5",children:[I.jsx("td",{className:"px-5 py-3 text-slate-300",children:P.date}),I.jsx("td",{className:"px-5 py-3 text-right font-semibold text-white",children:P.steps.toLocaleString()}),I.jsx("td",{className:"px-5 py-3 text-right",children:I.jsx("button",{onClick:()=>S(P.id),className:"text-xs text-red-400 hover:text-red-300",children:"Delete"})})]},P.id))})]})]})]})}const WD=[{value:"week",label:"This Week"},{value:"month",label:"This Month"},{value:"all",label:"All Time"}],qD=["🥇","🥈","🥉"];function HD(){const[t,e]=F.useState("month"),[n,r]=F.useState([]),[i,s]=F.useState(!0),o=Rr.currentUser;return F.useEffect(()=>{async function l(){s(!0);let u=null;t==="week"?u=new Date(Date.now()-7*864e5).toISOString().split("T")[0]:t==="month"&&(u=new Date(new Date().getFullYear(),new Date().getMonth(),1).toISOString().split("T")[0]);let c=u?us(Zt(Le,"stepEntries"),Jo("date",">=",u)):us(Zt(Le,"stepEntries"));const[f,p]=await Promise.all([En(c),En(Zt(Le,"users"))]),m={},S={};f.docs.forEach(k=>{const{userId:N,steps:T}=k.data();m[N]=(m[N]||0)+T,S[N]=(S[N]||0)+1});const P=p.docs.map(k=>({id:k.id,name:k.data().name,total_steps:m[k.id]||0,days_logged:S[k.id]||0}));P.sort((k,N)=>N.total_steps-k.total_steps),r(P.map((k,N)=>({...k,rank:N+1}))),s(!1)}l()},[t]),I.jsxs("div",{className:"space-y-5",children:[I.jsxs("div",{className:"flex items-center justify-between flex-wrap gap-3",children:[I.jsx("h2",{className:"text-xl font-bold text-white",children:"🏆 Leaderboard"}),I.jsx("div",{className:"flex gap-2 flex-wrap",children:WD.map(l=>I.jsx("button",{onClick:()=>e(l.value),className:"px-4 py-1.5 rounded-full text-sm font-medium transition-colors",style:t===l.value?{background:"#4f8ef7",color:"#fff"}:{background:"#1a1d27",color:"#94a3b8",border:"1px solid #2d3148"},children:l.label},l.value))})]}),I.jsx("div",{className:"rounded-xl overflow-x-auto",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:i?I.jsx("p",{className:"px-6 py-12 text-center text-slate-500",children:"Loading..."}):I.jsxs("table",{className:"w-full text-sm",children:[I.jsx("thead",{style:{background:"#212435"},children:I.jsxs("tr",{children:[I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium w-12",children:"Rank"}),I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium",children:"Name"}),I.jsx("th",{className:"text-right px-5 py-3 text-slate-400 font-medium",children:"Days"}),I.jsx("th",{className:"text-right px-5 py-3 text-slate-400 font-medium",children:"Total Steps"})]})}),I.jsx("tbody",{children:n.map(l=>I.jsxs("tr",{style:{borderBottom:"1px solid #2d3148",background:l.id===(o==null?void 0:o.uid)?"rgba(79,142,247,0.1)":"transparent"},className:"hover:bg-white/5",children:[I.jsx("td",{className:"px-5 py-3 font-bold text-slate-300",children:l.rank<=3?qD[l.rank-1]:`#${l.rank}`}),I.jsxs("td",{className:"px-5 py-3 text-white font-medium",children:[l.name,l.id===(o==null?void 0:o.uid)&&I.jsx("span",{className:"ml-2 text-xs text-blue-400",children:"(you)"})]}),I.jsx("td",{className:"px-5 py-3 text-right text-slate-400",children:l.days_logged}),I.jsx("td",{className:"px-5 py-3 text-right font-bold text-white",children:l.total_steps.toLocaleString()})]},l.id))})]})})]})}function KD({user:t,onRoleChange:e,onResetPassword:n,onDeleteUser:r}){const[i,s]=F.useState(!1),[o,l]=F.useState([]),[u,c]=F.useState(null),[f,p]=F.useState(""),[m,S]=F.useState({date:new Date().toISOString().split("T")[0],steps:""}),[P,k]=F.useState(!1);async function N(){k(!0);const b=us(Zt(Le,"stepEntries"),Jo("userId","==",t.id),r0("date","desc")),j=await En(b);l(j.docs.map(v=>({id:v.id,...v.data()}))),k(!1)}function T(){i||N(),s(!i)}async function _(b){await s0(Sn(Le,"stepEntries",b.id),{steps:parseInt(f),updatedAt:new Date().toISOString()}),c(null),N()}async function R(b){confirm("Delete this entry?")&&(await fu(Sn(Le,"stepEntries",b)),N())}async function O(b){b.preventDefault();const j=`${t.id}_${m.date}`,v=o.find(E=>E.date===m.date),y=(v?v.steps:0)+parseInt(m.steps);await yp(Sn(Le,"stepEntries",j),{userId:t.id,date:m.date,steps:y,updatedAt:new Date().toISOString()}),S({date:new Date().toISOString().split("T")[0],steps:""}),N()}return I.jsxs(I.Fragment,{children:[I.jsxs("tr",{onClick:T,className:"cursor-pointer hover:bg-white/5 transition-colors",style:{borderBottom:i?"none":"1px solid #2d3148"},children:[I.jsx("td",{className:"px-5 py-3",children:I.jsxs("div",{className:"flex items-center gap-2",children:[I.jsx("span",{className:"text-slate-400 text-xs transition-transform",style:{display:"inline-block",transform:i?"rotate(90deg)":"rotate(0deg)"},children:"▶"}),I.jsx("span",{className:"font-medium text-white",children:t.name})]})}),I.jsx("td",{className:"px-5 py-3 text-slate-400",children:t.email}),I.jsx("td",{className:"px-5 py-3",children:I.jsx("span",{className:"inline-flex px-2 py-0.5 rounded-full text-xs font-medium",style:t.role==="admin"?{background:"#2e1065",color:"#c4b5fd"}:{background:"#1e293b",color:"#64748b"},children:t.role})}),I.jsx("td",{className:"px-5 py-3 text-right",onClick:b=>b.stopPropagation(),children:I.jsxs("div",{className:"flex gap-3 justify-end flex-wrap",children:[I.jsx("button",{onClick:()=>e(t),className:"text-xs text-blue-400 hover:text-blue-300",children:t.role==="admin"?"Make User":"Make Admin"}),I.jsx("button",{onClick:()=>n(t),className:"text-xs text-yellow-400 hover:text-yellow-300",children:"Reset Password"}),I.jsx("button",{onClick:()=>r(t),className:"text-xs text-red-400 hover:text-red-300",children:"Delete"})]})})]}),i&&I.jsx("tr",{style:{borderBottom:"1px solid #2d3148"},children:I.jsx("td",{colSpan:4,className:"px-5 pb-4",style:{background:"#13151f"},children:I.jsxs("div",{className:"pt-3",children:[I.jsxs("p",{className:"text-xs font-semibold uppercase tracking-wide text-slate-500 mb-3",children:["Step Log for ",t.name]}),I.jsxs("form",{onSubmit:O,className:"flex flex-wrap gap-2 mb-4 items-end",children:[I.jsxs("div",{children:[I.jsx("label",{className:"block text-xs text-slate-500 mb-1",children:"Date"}),I.jsx("input",{type:"date",value:m.date,onChange:b=>S({...m,date:b.target.value}),className:"rounded-lg px-3 py-1.5 text-sm text-white outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#1a1d27",border:"1px solid #2d3148"}})]}),I.jsxs("div",{children:[I.jsx("label",{className:"block text-xs text-slate-500 mb-1",children:"Steps"}),I.jsx("input",{type:"number",required:!0,min:"0",max:"100000",value:m.steps,onChange:b=>S({...m,steps:b.target.value}),placeholder:"e.g. 8500",className:"rounded-lg px-3 py-1.5 text-sm text-white outline-none focus:ring-2 focus:ring-blue-500 w-32",style:{background:"#1a1d27",border:"1px solid #2d3148"}})]}),I.jsx("button",{type:"submit",className:"text-sm font-medium px-4 py-1.5 rounded-lg text-white",style:{background:"#4f8ef7"},children:"+ Add Steps"})]}),P?I.jsx("p",{className:"text-slate-500 text-sm py-2",children:"Loading..."}):o.length===0?I.jsx("p",{className:"text-slate-500 text-sm py-2",children:"No entries yet."}):I.jsxs("table",{className:"w-full text-sm rounded-lg overflow-hidden",style:{border:"1px solid #2d3148"},children:[I.jsx("thead",{style:{background:"#212435"},children:I.jsxs("tr",{children:[I.jsx("th",{className:"text-left px-4 py-2 text-slate-400 font-medium",children:"Date"}),I.jsx("th",{className:"text-right px-4 py-2 text-slate-400 font-medium",children:"Steps"}),I.jsx("th",{className:"px-4 py-2"})]})}),I.jsx("tbody",{children:o.map(b=>I.jsxs("tr",{style:{borderTop:"1px solid #2d3148"},className:"hover:bg-white/5",children:[I.jsx("td",{className:"px-4 py-2 text-slate-300",children:b.date}),I.jsx("td",{className:"px-4 py-2 text-right",children:u===b.id?I.jsx("input",{type:"number",value:f,onChange:j=>p(j.target.value),className:"rounded px-2 py-1 text-sm text-white w-24 text-right outline-none focus:ring-2 focus:ring-blue-500",style:{background:"#1a1d27",border:"1px solid #4f8ef7"},autoFocus:!0}):I.jsx("span",{className:"font-semibold text-white",children:b.steps.toLocaleString()})}),I.jsx("td",{className:"px-4 py-2 text-right",children:I.jsx("div",{className:"flex gap-3 justify-end",children:u===b.id?I.jsxs(I.Fragment,{children:[I.jsx("button",{onClick:()=>_(b),className:"text-xs text-green-400 hover:text-green-300",children:"Save"}),I.jsx("button",{onClick:()=>c(null),className:"text-xs text-slate-400 hover:text-slate-300",children:"Cancel"})]}):I.jsxs(I.Fragment,{children:[I.jsx("button",{onClick:()=>{c(b.id),p(b.steps)},className:"text-xs text-blue-400 hover:text-blue-300",children:"Edit"}),I.jsx("button",{onClick:()=>R(b.id),className:"text-xs text-red-400 hover:text-red-300",children:"Delete"})]})})})]},b.id))})]})]})})})]})}function GD(){const[t,e]=F.useState([]),[n,r]=F.useState("");async function i(){const f=(await En(Zt(Le,"users"))).docs.map(p=>({id:p.id,...p.data()}));f.sort((p,m)=>p.name.localeCompare(m.name)),e(f)}F.useEffect(()=>{i()},[]);async function s(c){const f=c.role==="admin"?"user":"admin";await s0(Sn(Le,"users",c.id),{role:f}),i()}async function o(c){try{await K1(Rr,c.email),r(`Password reset email sent to ${c.email}`)}catch{r(`Failed to send reset email to ${c.email}`)}}async function l(c){if(!confirm(`Delete ${c.name}? This will also delete all their step entries.`))return;const f=await En(us(Zt(Le,"stepEntries"),Jo("userId","==",c.id)));await Promise.all(f.docs.map(p=>fu(p.ref))),await fu(Sn(Le,"users",c.id)),r(`${c.name} deleted.`),i()}async function u(){const[c,f]=await Promise.all([En(Zt(Le,"users")),En(Zt(Le,"stepEntries"))]),p={};c.docs.forEach(k=>{p[k.id]=k.data()});let m=`Name,Email,Date,Steps
`;const S=f.docs.map(k=>({...k.data()})).sort((k,N)=>k.date>N.date?1:-1);m+=S.map(k=>{const N=p[k.userId]||{};return`"${N.name||""}","${N.email||""}","${k.date}",${k.steps}`}).join(`
`);const P=document.createElement("a");P.href=URL.createObjectURL(new Blob([m],{type:"text/csv"})),P.download="steps-export.csv",P.click()}return I.jsxs("div",{className:"space-y-5",children:[I.jsxs("div",{className:"flex items-center justify-between",children:[I.jsx("h2",{className:"text-xl font-bold text-white",children:"Admin Panel"}),I.jsx("button",{onClick:u,className:"text-sm font-medium px-4 py-2 rounded-lg text-white transition-colors",style:{background:"#212435",border:"1px solid #2d3148"},children:"Export CSV"})]}),n&&I.jsxs("div",{className:"p-3 rounded-lg text-sm font-medium flex justify-between items-center",style:{background:"#064e3b",color:"#6ee7b7"},children:[n,I.jsx("button",{onClick:()=>r(""),className:"text-green-400 hover:text-green-200 ml-4",children:"✕"})]}),I.jsxs("div",{className:"rounded-xl overflow-x-auto",style:{background:"#1a1d27",border:"1px solid #2d3148"},children:[I.jsx("div",{className:"px-5 py-4",style:{borderBottom:"1px solid #2d3148"},children:I.jsxs("h3",{className:"font-semibold text-white",children:["Users (",t.length,") ",I.jsx("span",{className:"text-xs text-slate-500 font-normal ml-2",children:"— click a user to view/edit their steps"})]})}),I.jsxs("table",{className:"w-full text-sm",children:[I.jsx("thead",{style:{background:"#212435"},children:I.jsxs("tr",{children:[I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium",children:"Name"}),I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium",children:"Email"}),I.jsx("th",{className:"text-left px-5 py-3 text-slate-400 font-medium",children:"Role"}),I.jsx("th",{className:"px-5 py-3"})]})}),I.jsx("tbody",{children:t.map(c=>I.jsx(KD,{user:c,onRoleChange:s,onResetPassword:o,onDeleteUser:l},c.id))})]})]})]})}function QD({role:t}){const e=ra(),n=ms(),r=Rr.currentUser,[i,s]=F.useState(!1);async function o(){await tP(Rr),e("/login")}const l=u=>`block px-4 py-2 rounded-md text-sm font-medium transition-colors ${n.pathname===u?"bg-blue-600 text-white":"text-slate-400 hover:text-white hover:bg-white/10"}`;return I.jsx("nav",{style:{background:"#1a1d27",borderBottom:"1px solid #2d3148"},children:I.jsxs("div",{className:"max-w-4xl mx-auto px-4",children:[I.jsxs("div",{className:"flex items-center justify-between h-14",children:[I.jsx("span",{className:"text-lg font-semibold text-white tracking-wide",children:"🏃 StepTracker"}),I.jsxs("div",{className:"hidden sm:flex items-center gap-1",children:[I.jsx(Kn,{to:"/",className:l("/"),children:"My Steps"}),I.jsx(Kn,{to:"/leaderboard",className:l("/leaderboard"),children:"Leaderboard"}),t==="admin"&&I.jsx(Kn,{to:"/admin",className:l("/admin"),children:"Admin"})]}),I.jsxs("div",{className:"hidden sm:flex items-center gap-3",children:[I.jsx("span",{className:"text-sm text-slate-400",children:r==null?void 0:r.displayName}),I.jsx("button",{onClick:o,className:"text-sm text-slate-400 hover:text-red-400 transition-colors",children:"Logout"})]}),I.jsx("button",{onClick:()=>s(!i),className:"sm:hidden p-2 rounded-md text-slate-400 hover:text-white hover:bg-white/10",children:i?I.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:I.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M6 18L18 6M6 6l12 12"})}):I.jsx("svg",{className:"w-6 h-6",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:I.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M4 6h16M4 12h16M4 18h16"})})})]}),i&&I.jsxs("div",{className:"sm:hidden pb-3 space-y-1 pt-2",style:{borderTop:"1px solid #2d3148"},children:[I.jsx(Kn,{to:"/",onClick:()=>s(!1),className:l("/"),children:"My Steps"}),I.jsx(Kn,{to:"/leaderboard",onClick:()=>s(!1),className:l("/leaderboard"),children:"Leaderboard"}),t==="admin"&&I.jsx(Kn,{to:"/admin",onClick:()=>s(!1),className:l("/admin"),children:"Admin"}),I.jsxs("div",{className:"px-4 pt-2 pb-1 flex items-center justify-between",style:{borderTop:"1px solid #2d3148"},children:[I.jsx("span",{className:"text-sm text-slate-400",children:r==null?void 0:r.displayName}),I.jsx("button",{onClick:o,className:"text-sm text-red-400 hover:text-red-300 font-medium",children:"Logout"})]})]})]})})}function u_({user:t,children:e}){return t===void 0?I.jsx("div",{className:"flex items-center justify-center min-h-screen text-gray-400",children:"Loading..."}):t?e:I.jsx($i,{to:"/login",replace:!0})}function YD({user:t,role:e,children:n}){return t===void 0?I.jsx("div",{className:"flex items-center justify-center min-h-screen text-gray-400",children:"Loading..."}):t?e!=="admin"?I.jsx($i,{to:"/",replace:!0}):n:I.jsx($i,{to:"/login",replace:!0})}function JD(){const[t,e]=F.useState(void 0),[n,r]=F.useState("user");return F.useEffect(()=>eP(Rr,async s=>{if(s){const o=await bD(Sn(Le,"users",s.uid));r(o.exists()?o.data().role:"user"),e(s)}else e(null),r("user")}),[]),I.jsxs("div",{className:"min-h-screen",children:[t&&I.jsx(QD,{role:n}),I.jsx("main",{className:"max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-8",children:I.jsxs(nR,{children:[I.jsx(qr,{path:"/login",element:t?I.jsx($i,{to:"/",replace:!0}):I.jsx(BD,{})}),I.jsx(qr,{path:"/register",element:t?I.jsx($i,{to:"/",replace:!0}):I.jsx(zD,{})}),I.jsx(qr,{path:"/",element:I.jsx(u_,{user:t,children:I.jsx($D,{})})}),I.jsx(qr,{path:"/leaderboard",element:I.jsx(u_,{user:t,children:I.jsx(HD,{})})}),I.jsx(qr,{path:"/admin",element:I.jsx(YD,{user:t,role:n,children:I.jsx(GD,{})})}),I.jsx(qr,{path:"*",element:I.jsx($i,{to:"/",replace:!0})})]})})]})}nh.createRoot(document.getElementById("root")).render(I.jsx(E_.StrictMode,{children:I.jsx(uR,{basename:"/steptracker",children:I.jsx(JD,{})})}));
